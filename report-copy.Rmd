...
rf_final <- finalize_workflow(rf_wf, best_mtry)
...
knn_final <- finalize_workflow(knn_wf, best_cost)
...
#
all_model_rsq <- c(boost_rsq, rf_rsq, knn_rsq, bag_rsq)
 
# 
all_model_rmse <- c(boost_rmse, rf_rmse, knn_rmse, bag_rmse)
