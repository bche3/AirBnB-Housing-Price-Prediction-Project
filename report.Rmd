...
# rf_params <- parameters(rand_forest) %>% 
...
```{r}
# Save
save(rand_forest_tune_res, rand_forest_wf, rand_forest_grid, rand_forest_spec, file = "scripts/model_fitting/rf_model.rda")
```
